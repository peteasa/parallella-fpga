...
proc addmailboxNoMove {name module} {
    ...
    addGroup $name $module.erx.erx_core.erx_mailbox wr_clk emesh_access emesh_write emesh_addr mailbox_write emesh_din rd_clk mi_en mi_rd mi_addr mailbox_read read_status read_hi read_lo mi_dout mailbox_irq_en mailbox_irq mailbox_empty mailbox_full emesh_packet mi_we mi_din 
